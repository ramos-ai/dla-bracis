...
def _sanitize_student_user(user: dict) -> dict:
    ...
    _set_class_id_from_field(user)
    user["classification_reliability"] = _reliability_summary(
        user.get("classification_reliability")
    )
...
def _reliability_summary(payload) -> dict | None:
...
def _user_profile(user: dict) -> dict:
    return {
        ...
        "classification_reliability": _reliability_summary(
            user.get("classification_reliability")
        ),
    }
