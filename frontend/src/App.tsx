...
import { AppShell } from "./components/dla/AppShell";
...
const ExportDataset = lazy(() => import("./pages/datasets/ExportDataset"));
...
const ResolveExercise = lazy(() => import("./pages/exercises/ResolveExercise"));
const ExerciseFeedback = lazy(() => import("./pages/exercises/ExerciseFeedback"));
const StudentSubmission = lazy(() => import("./pages/exercises/StudentSubmission"));
...
const prefetchRoutes = () => {
  const chunks = [
    ...
    import("./pages/exercises/ResolveExercise"),
    import("./pages/exercises/ExerciseFeedback"),
    import("./pages/exercises/StudentSubmission"),
    ...
    import("./pages/datasets/ExportDataset"),
...
const RouteContentWrapper = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <div key={location.pathname} className="page-fade-in flex h-full min-h-0 flex-col">
      {children}
    </div>
  );
};
      ...
      <Suspense fallback={<PageFallback />}>
        <RouteContentWrapper>
          <Routes>
            ...
            />
            <Route
              path="/exercises/resolution/:exerciseId"
              element={
                <ProtectedRoute>
                  <ResolveExercise />
                </ProtectedRoute>
            ...
            />
            <Route
              path="/exercises/resolution/:exerciseId/feedback"
              element={
                <ProtectedRoute>
                  <ExerciseFeedback />
                </ProtectedRoute>
            ...
            />
            <Route
              path="/exercises/:exerciseId/submissions/:userId"
              element={
                <ProtectedRoute>
                  <StudentSubmission />
                </ProtectedRoute>
