            ...
            <div className="profile-settings__section">
              ...
              <div className="profile-settings__actions">
                <button
                  ...
                  className="rounded-md bg-primary px-3.5 py-2 text-xs font-semibold text-primary-foreground transition-colors hover:bg-primary/90 disabled:opacity-50"
                >
              ...
              {kaggleStatus?.has_credentials ? (
                <div className="profile-settings__kaggle-configured">
                  ...
                  <button
                    ...
                    disabled={savingKaggle}
                    className="rounded-md border border-border px-3.5 py-2 text-xs font-semibold text-destructive transition-colors hover:border-destructive disabled:opacity-50"
                  >
            ...
            <div className="profile-settings__section">
              ...
              <div className="profile-settings__photo-actions">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-md bg-primary px-3.5 py-2 text-xs font-semibold text-primary-foreground transition-colors hover:bg-primary/90 disabled:opacity-50"
                >
                ...
                {user.profile_image_id && (
                  <button
                    ...
                    disabled={uploadingPhoto}
                    className="inline-flex items-center gap-1.5 rounded-md border border-border px-3.5 py-2 text-xs font-semibold text-destructive transition-colors hover:border-destructive disabled:opacity-50"
                  >
